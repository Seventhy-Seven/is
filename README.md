Разработать прототип интеллектуальной системы приготовления пищи (завтрак, обед, ужин, вечеринка) и управления запасами холодильников в студенческом общежитии. В зависимости от следующих параметров:
